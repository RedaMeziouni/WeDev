      ...
      <div class="container">
        <div class="nav-wrapper">
          ...
          <ul class="right hide-on-med-and-down">
            ...
            <li>
              <a class="active-link" href="solutions.php">Solutions</a>
            </li>
            <li>
        ...
        <div class="col s12 m6 offset-m1">
          <div class="row">
            <div class="col s12">
              <ul class="tabs">
                <li class="tab col s4">
                  <a href="#tab1" class="purple-text">Search Engine Optimization</a>
                </li>
                <li class="tab col s4">
                  <a href="#tab2" class="purple-text">Web Developpement</a>
                </li>
                <li class="tab col s4">
                  <a href="#tab3" class="purple-text">Database Management</a>
                </li>
              </ul>
            </div>
